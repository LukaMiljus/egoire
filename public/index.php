...
$routes = [
    ...
    'admin/product/delete-image' => ['admin/product-delete-image', 'admin'],
    ...
    'admin/gift-wrapping'       => ['admin/gift-wrapping', 'admin'],
    'admin/gift-wrapping/new'   => ['admin/gift-wrapping-edit', 'admin'],
    'admin/gift-wrapping/edit'  => ['admin/gift-wrapping-edit', 'admin'],
