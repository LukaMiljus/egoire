            ...
            <div class="co-info">
                ...
                <div class="co-info__items">
                    <div class="co-info__item">
                        ...
                        <div>
                            ...
                            <a href="mailto:office@egoire.rs" class="co-info__item-value">office@egoire.rs</a>
                        </div>
                    </div>
                    ...
                    <div class="co-info__item">
                        ...
                        <div>
                            <span class="co-info__item-label">Adresa</span>
                            <span class="co-info__item-value">Prvomajska 66A, Beograd</span>
                        </div>
                    </div>
                    ...
                    <div class="co-info__item">
                        ...
                        <div>
                            ...
                            <span class="co-info__item-value">Utorak–Petak: 10–19<br>Subota: 9–15</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="co-info__social">
                    ...
                    <div class="co-info__social-links">
                        <a href="https://www.instagram.com/egoire.rs" class="co-info__social-link" aria-label="Instagram">
                        ...
                        <a href="https://www.tiktok.com/@egoire_beauty?is_from_webapp=1&sender_device=pc" target="_blank" class="co-info__social-link" aria-label="TikTok">
...
<!-- ============================================================
     GOOGLE MAPS
     ============================================================ -->
<section class="co-map">
    <div class="co-container">
        <div class="co-map__header">
            <span class="co-map__label">Naša lokacija</span>
            <h2 class="co-map__title">Pronađite nas</h2>
            <p class="co-map__text">Prvomajska 66A, Beograd 11080</p>
        </div>
        <div class="co-map__frame">
            <iframe class="co-map__iframe"
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3429.439380047306!2d20.388710600000003!3d44.8417049!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475a65c0afdcaeeb%3A0x98df900dc625293d!2z0J_RgNCy0L7QvNCw0ZjRgdC60LAgNjZBLCDQkdC10L7Qs9GA0LDQtCAxMTA4MA!5e1!3m2!1ssr!2srs!4v1780169054319!5m2!1ssr!2srs"
                    allowfullscreen=""
                    loading="lazy"
                    referrerpolicy="no-referrer-when-downgrade"
                    title="Egoire — Andrejevića 66A, Beograd"></iframe>
        </div>
    </div>
</section>
