        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <h3 class="footer-logo">EGOIRE</h3>
                    <p class="footer-desc">Luksuzna nega kose. Premium brendovi i stručni saveti za vašu kosu.</p>
                ...
                <div class="footer-col">
                    ...
                    <div id="newsletterMsg" class="form-message" style="display:none;"></div>
                </div>
            </div>

            <div class="footer-bottom">
                <p>&copy; <?= date('Y') ?> Egoire. Sva prava zadržana.</p>
